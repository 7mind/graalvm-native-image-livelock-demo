...
object BIO3Syntax {
  ...
  trait BIO3ImplicitPuns extends BIO3ImplicitPuns1 {
    implicit final def BIOTemporal3[FR[-_, +_, +_]: Temporal3, R, E, A](self: FR[R, E, A]): Unit = ()
  ...
  trait BIO3ImplicitPuns2 extends BIO3ImplicitPuns3 {
    implicit final def BIOConcurrent3[FR[-_, +_, +_]: Concurrent3, R, E, A](self: FR[R, E, A]): Unit = ()
  ...
  trait BIO3ImplicitPuns3 extends BIO3ImplicitPuns4 {
    implicit final def BIOParallel3[FR[-_, +_, +_]: Parallel3, R, E, A](self: FR[R, E, A]): Unit = ()
  ...
  trait BIO3ImplicitPuns4 extends BIO3ImplicitPuns5 {
    ...
    /**
      ...
      * }}}
      */
    final def BIO3[FR[-_, +_, +_], A](effect: => A)(implicit F: IO3[FR]): FR[Any, Throwable, A] = F.syncThrowable(effect)
  ...
  trait BIO3ImplicitPuns12 extends BIO3ImplicitPuns13 {
    implicit final def BIOBifunctor3[FR[-_, +_, +_]: Bifunctor3, R, E, A](self: FR[R, E, A]): Unit = ()
  ...
  trait BIOImplicitPuns14 extends BIOImplicitPuns15 {
    ...
    implicit final def BIOLocal[FR[-_, +_, +_]: Local3, R, E, A](self: FR[R, E, A]): Unit = ()
    implicit final def BIOLocal[FR[-_, +_, +_]: Monad3, R, E, A](self: FR[R, E, A]): Unit = ()
  ...
  trait BIOImplicitPuns17 extends BIOImplicitPuns18 {
    implicit final def BIOArrowChoice[FR[-_, +_, +_]: ArrowChoice3, R, E, A](self: FR[R, E, A]): Unit = ()
  ...
  trait BIOImplicitPuns18 extends BIOImplicitPuns19 {
    implicit final def BIOArrow[FR[-_, +_, +_]: Arrow3, R, E, A](self: FR[R, E, A]): Unit = ()
  ...
  trait BIOImplicitPuns19 extends BIOImplicitPuns20 {
    implicit final def BIOProfunctor[FR[-_, +_, +_]: Profunctor3, R, E, A](self: FR[R, E, A]): Unit = ()
